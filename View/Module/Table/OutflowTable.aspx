...
<asp:Content ID="Content2" ContentPlaceHolderID="CurrentList" runat="server">
    <ul>
        ...
        <li style="float:left;width:160px;"><a id="list1" href="InflowTable.aspx">入库流水</a></li>
        <li style="float:left;width:160px;"><a id="list2" href="OutflowTable.aspx" style="background-color:#63b5de9c">出库流水</a></li>
