...
function addRecord() { 
    html = "<tr id=\"newOne\" class=\"dataRow3\"  style=\"height:50px;width:130px\"><td>请依次填充id之后的内容 </td><td contentEditable=\"true\" class=\"dbclicktd\"> </td><td contentEditable=\"true\" class=\"dbclicktd\"> </td><td contentEditable=\"true\" class=\"dbclicktd\"> </td></tr>";
    $("#caption").after(html);
}
