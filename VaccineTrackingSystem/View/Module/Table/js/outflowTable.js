function createOutflowTable(temp, extra) {
    ...
    var html = "<tr id=\"caption\"><th>药品编码</th><th>药品名称</th><th>药品种类</th><th>药品规格</th><th>关联库房</th><th>出库时间</th><th>操作人</th><th>数量</th><th>单价</th><th>到期时间</th><th>状态</th></tr>";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (temp.code == 200) {
                ...
                var shhead ="";
                switch (temp.extra) {
                    case "0": option.fileName = "出库流水表"; shhead = ['出库流水编号','药品编码', '药品名称', '药品种类', '药品规格', '关联库房', '出库时间', '操作人', '数量', '单价', '到期时间','状态']; break;
                } 
                option.datas = [
                    {
